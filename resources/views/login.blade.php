    ...
    <div class="grid place-items-center  h-[80vh] ">
        <div class="items-center justify-center backdrop-blur-sm shadow-lg rounded p-8 m-1 bg-white/50 ">
            <form action="{{route('verification')}}" method="POST">
                ...
                <input class="float-left text-center rounded p-2 my-1 hover:backdrop-blur-sm hover:text-white/70 hover:bg-cyan-700/70 bg-white/50" onclick="this.hidden=true" value="Login" type="submit">
            </form>

            <form action="{{route('register')}}" method="GET">

                <input class="float-right text-center rounded p-2 my-1 hover:backdrop-blur-sm hover:text-white/70 hover:bg-cyan-700/70 bg-white/50" onclick="this.hidden=true" value="Register" type="submit">
            </form>
